...
import Header from "../Ferramentas/ferramentas";
import Animator from "../../algoritmos/animations";
import Grid from "../../algoritmos/grid";
import {
  algo,
  IGrid,
  INodeProperties,
...
import Node from "../No/no";
import "./tabela.css";
import { DefaultValues } from "../../algoritmos/helper";
...
export default class Visualizer extends Component<{}, IVisualizerState> {
  ...
  visualize() {
    ...
    if (grid && start && end && algo && animator) {
      ...
      let visitedNodesInOrder: Array<INodeProperties> | undefined =
        traverser.traverse(grid.grid, startNode, endNode);
      ...
      <div className="holder">
        ...
        <div className="body">
          <div className="information">
            <h3>Algoritmo de {this.state.algoText}</h3>
          </div>
          <div className="board">
